      ...
      <div className="container mx-auto px-4">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Indore M.P. India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+91 74703 85513</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">scotlandyardproductions@gmail.com</p>
                  </div>
                </div>
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Find answers to common questions about our wedding photography services.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground">
                We recommend booking 6-12 months in advance, especially for peak wedding season dates (October-February). Popular dates can book up quickly.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Our packages start from ₹75,000 and vary based on coverage hours, number of photographers, and deliverables. We can create custom packages to suit your needs.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Yes, we love destination weddings! We have photographed weddings across India and internationally. Travel and accommodation costs are additional.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                You'll receive a sneak peek within 1-2 weeks after your wedding. The complete gallery is typically delivered within 6-8 weeks.
              </p>
            </motion.div>
          </div>
        </motion.div>
